...
export declare enum EAdsFormats {
    REWARD = "reward",
...
export declare enum EGetLaunchParamsResponseLanguages {
    RU = "ru",
    UK = "uk",
    UA = "ua",
    EN = "en",
...
export declare enum EGetLaunchParamsResponseGroupRole {
    ADMIN = "admin",
    EDITOR = "editor",
    MEMBER = "member",
    MODER = "moder",
...
export declare enum EGetLaunchParamsResponsePlatforms {
...
export declare type ReceiveDataMap = {
    ...
    VKWebAppLibverifyOnFailed: {
        code: VKWebAppLibverifyOnFailedCode;
    };
